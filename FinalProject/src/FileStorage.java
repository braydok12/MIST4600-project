...
public class FileStorage {
	...
	public static HashMap<String, Stock> readData(StockAccount acct) {
		...
		try {
        	...
        	BufferedReader reader = new BufferedReader(new FileReader("/Users/josephenck/eclipse-workspace/FinalProject/src/data.txt"));
	...
	public static void storeData(HashMap<String, Stock> market, StockAccount acct) {
		...
		try {
	        ...
	        FileWriter writer = new FileWriter("/Users/josephenck/eclipse-workspace/FinalProject/src/data.txt" , false);
	        writer.write(data);
	        writer.close();
